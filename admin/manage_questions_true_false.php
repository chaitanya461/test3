                                    ...
                                    <?php foreach ($questions as $question): ?>
                                        <tr>
                                            ...
                                            <td class="options-cell">
                                                <?php 
                                                // Display options based on what exists in the database
                                                echo "A: " . htmlspecialchars($question['option_a'] ?? '') . "<br>";
                                                echo "B: " . htmlspecialchars($question['option_b'] ?? '') . "<br>";
                                                
                                                // Only show C and D if they have values
                                                if (!empty($question['option_c'])) {
                                                    echo "C: " . htmlspecialchars($question['option_c']) . "<br>";
                                                }
                                                if (!empty($question['option_d'])) {
                                                    echo "D: " . htmlspecialchars($question['option_d']);
                                                }
                                                
                                                // Check if it's a True/False question (no C and D options)
                                                if (empty($question['option_c']) && empty($question['option_d'])) {
                                                    echo "<small style='color: #666;'>(True/False Question)</small>";
                                                }
                                                ?>
                                            </td>
