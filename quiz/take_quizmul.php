...
<style>
    ...
    .true-false-options label.true-option:hover {
        background-color: #e8f5e8;
        border-color: #4caf50;
    }
    .true-false-options label.false-option:hover {
        background-color: #ffe8e8;
        border-color: #f44336;
    }
    .true-false-options input[type="radio"]:checked + label.true-option {
        background-color: #4caf50;
        color: white;
        border-color: #4caf50;
    }
    .true-false-options input[type="radio"]:checked + label.false-option {
        ...
        <div class="question-card">
            ...
            <p class="question-type">
                ...
                switch($question['question_type']) {
                    case 'single': $type_text = 'Select one answer'; break;
                    case 'multi': $type_text = 'Select all that apply'; break;
                    case 'true_false': $type_text = 'True or False'; break;
                    default: $type_text = 'Select one answer';
                }
                echo $type_text;
                ?>
            </p>
            ...
            <div class="options">
                <?php if ($question['question_type'] === 'true_false'): ?>
                    ...
                    <div class="true-false-options">
                        <input type="radio" id="question_<?= $question['question_id'] ?>_true" 
                               name="question_<?= $question['question_id'] ?>" value="true" required>
                        <label for="question_<?= $question['question_id'] ?>_true" class="true-option">True</label>
                        
                        <input type="radio" id="question_<?= $question['question_id'] ?>_false" 
                               name="question_<?= $question['question_id'] ?>" value="false" required>
                        <label for="question_<?= $question['question_id'] ?>_false" class="false-option">False</label>
                    </div>
                <?php else: ?>
